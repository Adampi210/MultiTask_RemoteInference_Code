...
def build_scenarios():
    ...
    scenarios = [
        ...
        {"name": "probabilistic_two_cluster",
         "mode": "probabilistic", "q_profile": "two_cluster_60_95",
         "problem": small},
        {"name": "probabilistic_uniform_wide",
         "mode": "probabilistic", "q_profile": "uniform_wide",
         "problem": small},
        {"name": "probabilistic_adversarial",
         "mode": "probabilistic", "q_profile": "adversarial_by_penalty_type",
         "problem": small},
    ]

    if FAST:
        keep = {"deterministic_synthetic_small",
                "probabilistic_two_cluster",
...
def main():
    ...
    # Write CSVs.
    data_csv = os.path.join(HERE, "PrecheckSubgradientMethods_data.csv")
    ...
    # Summary CSV.
    summary_csv = os.path.join(HERE, "PrecheckSubgradientMethods_summary.csv")
    ...
    # Plot.
    plot_path = os.path.join(HERE, "PrecheckSubgradientMethods.png")
    try:
