...
_FIRST_ORDER_PROB = (set(get_default_subgradient_methods())
                     | {"constant", "normalized", "polyak_like",
                        "episode1_mstep"})
...
def _learn_multipliers(
    ...
    if subgradient_method in _FIRST_ORDER_PROB:
...
def MGF1_probabilistic(
    ...
    titer=10000,
    subgradient_method="episode1_mstep",
    beta=0.9,
    seed=0,
    mc_trials=1,
    verbose=True,
